...
logEucl_est  =load('./svm_results_nor/svm_LogEucl_est_labels.dat');
logEucl_real =load('./svm_results_nor/svm_LogEucl_real_labels.dat');
...
Steindiv_est  =load('./svm_results_nor/svm_SteinDiv_est_labels.dat');
Steindiv_real =load('./svm_results_nor/svm_SteinDiv_real_labels.dat');
...
PM_est  =load('./svm_results_nor/svm_Grass_PM_est_labels.dat');
PM_real =load('./svm_results_nor/svm_Grass_PM_real_labels.dat');
...
BC_est  =load('./svm_results_nor/svm_Grass_BC_est_labels.dat');
BC_real =load('./svm_results_nor/svm_Grass_BC_real_labels.dat');
