 ...
 inline
 uword
 kth_cv::logEucl_one_seg_est_lab(int pe_test, std::string load_sub_path, std::string segm_name)
 {
   //wall_clock timer;
   //timer.tic();
 ...
 inline
 uword
 kth_cv::SteinDiv_one_seg_est_lab(int pe_test, std::string load_sub_path, std::string segm_name)
 {
   //wall_clock timer;
   //timer.tic();
